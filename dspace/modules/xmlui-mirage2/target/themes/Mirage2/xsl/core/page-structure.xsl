        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
                    ...
                    <xsl:text>images/favicon.ico</xsl:text> //harsh
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/photo.jpg</xsl:text>
                </xsl:attribute>
            </link>
        ...
        <tr>
            ...
            <td>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <img src="{$theme-path}/images/1.png"> 
                            <xsl:attribute name="href">
                                <xsl:value-of select="mets:FLocat[@LOCTYPE='URL']/@xlink:href"/>
                            </xsl:attribute>
...
<!-- Getting bitstreams by ID XMLUI: /xmlui/bitstream/id  JSPUI: /jspui/retrieve -->
            ...
            <div class="navbar navbar-default navbar-static-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" >
                            <h1 style="color:white"><b>IIT BOMBAY</b></h1>
                        </a>
	...
	<div style="background-color:#1F3F5E;" >
		<div class="container" >
			<ul class="nav navbar-nav">
			<li><a href="/"><span style="color:white;">Home</span></a></li>
			<li><a href="/page/about"><span style="color:white;">About Us</span></a></li>
			</ul>
		</div>
